...
public class Pacientes {
    ...
    public void guardar_pacientes(ArrayList<String>listaPaciente){
        String arch = "C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\pacientes.csv" ;
        ...
        try{
          ...
          public void cargar_pacientes(ArrayList<String>listaPaciente){
              ...
              try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\pacientes.csv" ))){
    ...
    public void guardar_id(ArrayList<String>lista_id){
        String arch = "C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\id_pacientes.csv" ;
        File  file= new File(arch);
        BufferedWriter bufferedWriter = null;
    ...
    public void cargar_id(ArrayList<String>listaPaciente){
        ...
        ArrayList<String> arr = listaPaciente;
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\id_pacientes.csv" ))){
