...
public  class Doctores {
    ...
    public void guardar_doctores(ArrayList<String>lista_doctores){
        String arch = "C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\doctores.csv" ;
    ...
    public void guardar_departamento(ArrayList<String>lista_departamento){
        String arch = "C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\departamento.csv" ;
        File  file= new File(arch);
        BufferedWriter bufferedWriter = null;
        try {
            bufferedWriter = new BufferedWriter(new FileWriter(file));
    ...
    public  void agregar_departamentoyID(){
        ...
        System.out.println("Escribe el Departamento del doctor:");
    ...
    public void cargar_doctores(ArrayList<String>lista_doctores){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\doctores.csv"))){
    ...
    public void cargar_departamentos(ArrayList<String>lista_departamento){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\departamento.csv"))){
