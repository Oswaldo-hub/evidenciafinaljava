...
public class Cita {
    ...
    public void guardar_citas(ArrayList<String>lista_citas){
        String arch = "C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\citas.csv" ;
    ...
    public void cargar_citas(ArrayList<String>lista_citas){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Oswal\\IdeaProjects\\evidenciav2\\src\\DB\\citas.csv"))){
